// ─── /dashboard-v2 — Executive Redesign ────────────────────────────────────
// Mounted side-by-side with the existing /  Overview.  Light mode is the
// default; theme toggle in TopBar flips to "boardroom" dark.
//
// Phases:
//   ✓ 1 — Foundation (tokens, theme toggle, TopBar, time control)
//   ✓ 2 — NarrativeBanner + 5 hero KPI cards (live data, vs LY)
//   ✓ 3 — India heatmap, aging waterfall, today-vs-LY, channel mix, SKU pulse
//   ✓ 4 — Needs Attention right rail + Filter drawer + Saved views
...
// Default mode/valuation match the existing /  Overview defaults.
...
export default function DashboardV2() {
  ...
  // Saved views — apply a recipe.  Phase 5 will persist user-defined recipes.
  ...
  if (loading) {
    return (
      <div style={{
        ...
        background: '#FAFAFA', color: '#5B6470', fontSize: 13, fontFamily: 'Inter, sans-serif',
      }}>
        Loading Spykar IQ…
      </div>
    );
